...
If you have questions, please ask them on the [forum](http://revaluesoft.com/).
...
To manually install Revalue ERP here are the steps
### Manual Install
...
* Add apps
	...
	The get-app command gets remote frappe apps from a remote git repository and installs them. Example: [Revalue ERP](https://github.com/elba7r/system-v10)
...
- If you find any problems, post them on the forum: [http://revaluesoft.com](http://revaluesoft.com)
...
Download the Script
	...
	curl "https://raw.githubusercontent.com/elba7r/platform-v10/master/playbooks/install.py" -o install.py
...
4. For more details, [read the instructions on the Frappé Docker README](https://github.com/elba7r/frameworking-v10_docker/)
