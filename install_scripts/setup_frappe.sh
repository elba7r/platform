...
install_bench() {
	run_cmd sudo su $FRAPPE_USER -c "cd /home/$FRAPPE_USER && git clone https://github.com/elba7r/platform --branch $BENCH_BRANCH bench-repo"
...
setup_bench() {
	...
	ERPNEXT_APPS_JSON="https://raw.githubusercontent.com/elba7r/platform/master/install_scripts/erpnext-apps.json"
	if $SETUP_PROD; then
		FRAPPE_BRANCH="master"
		ERPNEXT_APPS_JSON="https://raw.githubusercontent.com/elba7r/platform/master/install_scripts/erpnext-apps-master.json"
	fi
