...
def get_frappe(bench_path='.'):
	...
	if not os.path.exists(frappe):
		...
		print('bench get-app https://github.com/elba7r/frameworking-v10.git')
	return frappe
...
def init(path, apps_path=None, no_procfile=False, no_backups=False,
	...
	if clone_from:
		...
		if not frappe_path:
			frappe_path = 'https://github.com/elba7r/frameworking-v10.git'
...
def update_translations(app, lang):
	...
	url = "https://translate.revaluesoft.com/files/{}-{}.csv".format(app, lang)
